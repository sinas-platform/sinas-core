...
function CodeBlock({ code }: { code: string }) {
  ...
  return (
    <div className="relative group">
      <pre className="text-xs text-gray-800 whitespace-pre-wrap font-mono overflow-x-auto bg-gray-50 p-3 rounded border border-gray-200 pr-10">
        <code>{code}</code>
      </pre>
      <button
        type="button"
        onClick={handleCopy}
        className="absolute top-2 right-2 p-1 rounded text-gray-400 hover:text-gray-600 hover:bg-gray-200 opacity-0 group-hover:opacity-100 transition-opacity"
