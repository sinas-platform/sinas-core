...
Revision ID: c09b0af1c107
Revises: 
Create Date: 2026-01-07 08:33:29.280562
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('llm_provider_id', postgresql.UUID(), nullable=True),
    ...
    sa.Column('revoked_by', postgresql.UUID(), nullable=True),
    ...
    sa.Column('installed_by', postgresql.UUID(), nullable=True),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('function_id', postgresql.UUID(), nullable=False),
